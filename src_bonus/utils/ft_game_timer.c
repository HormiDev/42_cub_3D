...
/*   Updated: 2026/03/29 20:22:17 by ismherna          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Añade un valor como dos dígitos al buffer (con cero a la izquierda si hace falta).
 *
 * Escribe en `buf` a partir de la posición `len` el `value` como texto garantizando
 ...
 *
 * @param str Buffer donde se escribirá la cadena resultante (debe ser lo bastante grande).
 ...
 *
 * @param game Puntero al estado del juego usado para obtener render, fuente y estado.
 */
