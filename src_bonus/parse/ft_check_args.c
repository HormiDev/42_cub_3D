...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/07 02:13:40 by username          #+#    #+#             */
/*   Updated: 2026/04/07 23:39:33 by ide-dieg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*
* comprueba que se proporcione exactamente un argumento, el cual debe ser
* un archivo con extensión ".cub". Si no imprime un mensaje
