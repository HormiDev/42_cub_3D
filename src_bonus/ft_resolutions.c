...
/*   Updated: 2025/12/16 01:20:17 by ide-dieg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_init_resolutions(t_game *game)
{
	...
	game->resolutions[0].width = 120;
	game->resolutions[0].height = 90;
	game->resolutions[1].width = 240;
	game->resolutions[1].height = 180;
	game->resolutions[2].width = 360;
	game->resolutions[2].height = 240;
	game->resolutions[3].width = 480;
	game->resolutions[3].height = 360;
	game->resolutions[4].width = 640;
	game->resolutions[4].height = 480;
	game->resolutions[5].width = 960;
	game->resolutions[5].height = 720;
