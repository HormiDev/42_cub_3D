 ...
 *
 * funciones para manejar la lectura de texturas desde archivos XPM,
 * incluyendo la verificación de argumentos y el conteo de caracteres
 */
 ...
 *
 * comprueba que una línea de un archivo XPM contenga comillas y que tenga
 * el formato correcto como una línea de definición de color.
 *
